...
function Start-NotepadPlusPlus {
    ...
    .SYNOPSIS
        Opens in Notepad++.
    .DESCRIPTION
        Calls the `notepad++` command, and locates it on Windows if it isn't in the Path.
    .INPUTS
        None
    .OUTPUTS
        None
    ...
    #>
    Invoke-Expression "notepad++" $args
}
...
function Build-Sencha {
    <#
    .SYNOPSIS
        Sencha: runs the app build command in a given working directory.
    .INPUTS
        None
    .OUTPUTS
        None
...
function Build-Sencha-OnCourse {
    Build-Sencha -Path "~\Work\oncourse\oncourse\src\web.ui\content\oncourse" -Environment development
}

function Build-Sencha-Intranet {
    Build-Sencha -Path "~\Work\oncourse\oncourse\src\intranet.ui\content\oncourse" -Environment development
}
