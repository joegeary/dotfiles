...
Set-Alias -Name "npp" -Value Start-NotepadPlusPlus -Description "Opens in Notepad++."
...
Set-Alias -Name "sbo" -Value Build-Sencha-OnCourse -Description "Sencha: builds the Web.UI application."
Set-Alias -Name "sbi" -Value Build-Sencha-Intranet -Description "Sencha: builds the Intranet.UI application."
